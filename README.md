...
_Примеры SQL-запросов для основных операций_
...
_Запрос на получение 10 самых популярных фильмов
Популярность определяется количеством лайков. Фильмы сортируются по убыванию числа лайков._
...
_Поиск общих друзей
Запрос для нахождения общих друзей между пользователями с ID 1 и 2._
